...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            artifactId = "knotx-fragments-supplier-api"
            from(components["java"])
            artifact(tasks["sourcesJar"])
            artifact(tasks["javadocJar"])
            pom {
                name.set("Knot.x Fragments Supplier API")
                description.set("Fragments Supplier API module contains Fragment supplier abstract handler.")
