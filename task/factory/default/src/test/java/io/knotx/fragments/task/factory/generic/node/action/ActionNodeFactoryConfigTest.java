...
class ActionNodeFactoryConfigTest {
  ...
  void expectNoLogLevel(Vertx vertx) throws Throwable {
    verify("conf/node/action/actionNodeFactoryWithNoGlobalLogLevel.conf",
  ...
  void expectLogLevel(Vertx vertx) throws Throwable {
    ...
    verify("conf/node/action/actionNodeFactoryWithGlobalLogLevel.conf",
  ...
  void expectLocalLogLevel(Vertx vertx) throws Throwable {
    ...
    verify("conf/node/action/actionNodeFactoryWithLocalLogLevel.conf",
